...
public class WebViewActivity extends CordovaActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        loadUrl((url.matches("^(.*://|javascript:)[\\s\\S]*$") ? ""
                : "file:///android_asset/www/" + (isPluginWkwebviewPolyfillActive() ? "+++/" : "")) + url);
    }
    ...
    public void onBackPressed() {
        CallbackContext subscribeExitCallbackContext = SubscribeExitCallback.getInstance().getCallbackContext();
    ...
    /**
     * Revisa si existe la clase con nombre className dentro del contexto donde esté
     * integrado este plugin
     * 
